...
export function SemesterReviewGroup({ semester, courses, onSetSubstitution }: SemesterReviewGroupProps) {
  ...
  return (
    <Card className="mb-3.5">
      ...
      {courses.map((c) => (
        <CourseReviewRow key={c.id} course={c} onSetSubstitution={onSetSubstitution} />
      ))}
    </Card>
  );
}
