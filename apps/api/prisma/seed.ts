...
async function main() {
  ...
  // 미디어기술콘텐츠학과 트랙별 전공인정과목(★미디어기술콘텐츠학과 트랙교과목_20240813.pdf 원문 그대로
  // 옮김, 2024.8 기준 — 트랙별_전공인정과목.xlsx는 이 PDF를 표 추출한 파생본이라 컬럼 경계 오류가
  // 섞여 있어[일부 과목이 실제와 다른 영역에 배정됨] 대신 PDF 원문을 직접 기준으로 삼았다). trackId
  // 13/14/15(문화콘텐츠/미디어공학/테크니컬아티스트)에서 과목별로 어떤 세부 영역에 인정되는지를
  // 담는다 — graduation.service.ts의 resolveTrackAreaBreakdown()이 학생이 이 트랙을 선택했을 때
  // 과목명(+개설학과명, 있으면)으로 매칭해 트랙별 이수학점을 다시 집계한다. "트랙미이수"(id 12)는
  // 이 표에 없어도 기존 category 기반 계산을 그대로 쓴다(사용자 확인 — 트랙 미선택 시 기본값).
  // offeringDepartmentName이 null이면 미디어기술콘텐츠학과 자체 개설 과목, 채워져 있으면 그 학과가
  // 개설한 과목을 이 학과 전공으로 인정한다는 뜻(예: 06196 데이터과학을위한프로그래밍은 경영학과 개설
  // — "전체 과목 목록(참고)" 시트의 2020~2026 개설이력으로 개설학과를 대조해 확정함).
  const TRACK_COURSE_RECOGNITIONS: Array<{
    trackId: number;
    courseCode: string;
    courseName: string;
    area: string;
    ...
    { trackId: 13, courseCode: '04480', courseName: '디지털스토리텔링입문', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '04478', courseName: '영상창작기초', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '05292', courseName: '다큐멘터리기획개론', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '04867', courseName: '발상표현과스토리보드', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '04483', courseName: '3D애니메이션1', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '04683', courseName: '영상편집과특수효과1', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '04692', courseName: '영상제작세미나', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '05294', courseName: '미디어콘텐츠디자인1', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '05800', courseName: '창의적콘텐츠프로젝트종합설계', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '03994', courseName: '인터랙션디자인', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '04486', courseName: '3D애니메이션2', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '04693', courseName: '영상편집과특수효과2', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '04487', courseName: '인터렉티브프로젝트실습', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '03997', courseName: '광고기획및제작', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '05532', courseName: '미디어콘텐츠캡스톤디자인2', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '04865', courseName: '디지털영상제작', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '06083', courseName: '디지털스토리텔링캡스톤디자인', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '04582', courseName: '영상연출과연기실습', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '05793', courseName: '디지털미디어정보수학', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '06686', courseName: '미디어기술콘텐츠현장실습Ⅰ', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '06687', courseName: '미디어기술콘텐츠현장실습Ⅱ', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '06688', courseName: '미디어기술콘텐츠현장실습Ⅲ', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '06689', courseName: '미디어기술콘텐츠현장실습Ⅳ', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '06690', courseName: '미디어기술콘텐츠현장실습Ⅴ', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '05531', courseName: '미디어콘텐츠캡스톤디자인1', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '06178', courseName: '스크린라이팅종합설계', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '06177', courseName: '유튜브콘텐츠어드벤처디자인', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '06196', courseName: '데이터과학을위한프로그래밍', area: '기획창작영역', offeringDepartmentName: '경영학과' },
    { trackId: 13, courseCode: '03988', courseName: '사운드디자인및편집', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '04680', courseName: '문화경영의실습', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '04479', courseName: '영상콘텐츠창작실습', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '05291', courseName: '미디어콘텐츠디자인2', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '05182', courseName: '콘텐츠산업창업론', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '06085', courseName: '문화브랜딩개발실습종합설계', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '05424', courseName: '스마트미디어기획실습', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '04690', courseName: '콘텐츠마케팅', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '04681', courseName: '문화정책의이해', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '04866', courseName: '콘텐츠산업의이해', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '04685', courseName: '콘텐츠분석', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '05792', courseName: '기술경영과전략기획', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '05835', courseName: '스마트미디어웨어러블IoT융합종합설계', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '05694', courseName: '지적재산권의이해와실무', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '00254', courseName: '문학사회학', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '00499', courseName: '소비자행동론', area: '콘텐츠비즈니스영역', offeringDepartmentName: '경영학과' },
    { trackId: 13, courseCode: '00521', courseName: '시장조사론', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '01070', courseName: '한국예술사', area: '콘텐츠비즈니스영역', offeringDepartmentName: '국사학과' },
    { trackId: 13, courseCode: '01494', courseName: '소비자심리학', area: '콘텐츠비즈니스영역', offeringDepartmentName: '심리학과' },
    { trackId: 13, courseCode: '01954', courseName: '지방행정론', area: '콘텐츠비즈니스영역', offeringDepartmentName: '행정학과' },
    { trackId: 13, courseCode: '02388', courseName: '국제무역론', area: '콘텐츠비즈니스영역', offeringDepartmentName: '경제학과' },
    { trackId: 13, courseCode: '02837', courseName: '사회문제론', area: '콘텐츠비즈니스영역', offeringDepartmentName: '사회복지학과' },
    { trackId: 13, courseCode: '02839', courseName: '사회복지조사론', area: '콘텐츠비즈니스영역', offeringDepartmentName: '사회복지학과' },
    { trackId: 13, courseCode: '03022', courseName: '대중문화론', area: '콘텐츠비즈니스영역', offeringDepartmentName: '사회학과' },
    { trackId: 13, courseCode: '03023', courseName: '영상사회론', area: '콘텐츠비즈니스영역', offeringDepartmentName: '사회학과' },
    { trackId: 13, courseCode: '06107', courseName: '한국고전문학과현대문화', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 13, courseCode: '03691', courseName: '한국현대문학비평론', area: '콘텐츠비즈니스영역', offeringDepartmentName: '국어국문학과' },
    { trackId: 13, courseCode: '03693', courseName: '한국고전소설론', area: '콘텐츠비즈니스영역', offeringDepartmentName: '국어국문학과' },
    { trackId: 13, courseCode: '05219', courseName: '소비자트랜드', area: '콘텐츠비즈니스영역', offeringDepartmentName: '공간디자인·소비자학과' },
    { trackId: 13, courseCode: '05250', courseName: '미-중관계와동아시아질서', area: '콘텐츠비즈니스영역', offeringDepartmentName: '국제학부' },
    { trackId: 14, courseCode: '05513', courseName: '디지털미디어공학개론', area: '기초영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '04014', courseName: '신호처리개론', area: '기초영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '04027', courseName: '웹프로그래밍', area: '기초영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '04481', courseName: '창의입문설계', area: '기초영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '06001', courseName: '데이터구조개론및응용', area: '기초영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '04695', courseName: '윈도우즈프로그래밍', area: '기초영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '06000', courseName: '미디어정보처리회로및응용', area: '기초영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '06265', courseName: '객체지향프로그래밍', area: '기초영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '03142', courseName: '논리회로및실험', area: '기초영역', offeringDepartmentName: '정보통신전자공학부' },
    { trackId: 14, courseCode: '03145', courseName: '신호및시스템', area: '기초영역', offeringDepartmentName: '인공지능학과' },
    { trackId: 14, courseCode: '03267', courseName: '자료구조기초', area: '기초영역', offeringDepartmentName: '인공지능학과' },
    { trackId: 14, courseCode: '06266', courseName: '기계학습입문', area: '필수영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '05801', courseName: '창의적미디어프로젝트종합설계', area: '필수영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '04015', courseName: '확률과통계', area: '필수영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '06264', courseName: '컴퓨터비전입문', area: '필수영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '04010', courseName: '선형대수학', area: '필수영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '05793', courseName: '디지털미디어정보수학', area: '필수영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '03988', courseName: '사운드디자인및편집', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '04588', courseName: '영상및비디오처리', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '03980', courseName: '컴퓨터애니메이션', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '06915', courseName: '휴먼컴퓨터인터랙션디자인', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '04497', courseName: '비주얼특수효과', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '04035', courseName: '모바일게임', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '05574', courseName: '스마트미디어캡스톤디자인', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '06685', courseName: '컴퓨터그래픽스와딥러닝', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '05078', courseName: '가상및증강현실', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '04020', courseName: '로봇공학개론', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '03993', courseName: '컴퓨터그래픽스', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '04587', courseName: '게임프로그래밍', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '06684', courseName: '영상처리알고리즘입문', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '05792', courseName: '기술경영과전략기획', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '05835', courseName: '스마트미디어웨어러블IoT융합종합설계', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '06686', courseName: '미디어기술콘텐츠현장실습Ⅰ', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '06687', courseName: '미디어기술콘텐츠현장실습Ⅱ', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '06688', courseName: '미디어기술콘텐츠현장실습Ⅲ', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '06689', courseName: '미디어기술콘텐츠현장실습Ⅳ', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '06690', courseName: '미디어기술콘텐츠현장실습Ⅴ', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '06268', courseName: '기계학습응용', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '06267', courseName: '인공지능비즈니스모델의이해', area: '응용영역', offeringDepartmentName: null },
    { trackId: 14, courseCode: '03161', courseName: '컴퓨터그래픽스', area: '응용영역', offeringDepartmentName: '컴퓨터정보공학부' },
    { trackId: 14, courseCode: '03151', courseName: '컴퓨터구조', area: '응용영역', offeringDepartmentName: '인공지능학과' },
    { trackId: 14, courseCode: '03152', courseName: '운영체제', area: '응용영역', offeringDepartmentName: '컴퓨터정보공학부' },
    { trackId: 14, courseCode: '03159', courseName: '마이크로프로세서', area: '응용영역', offeringDepartmentName: '컴퓨터정보공학부' },
    { trackId: 14, courseCode: '03905', courseName: '실시간운영체제', area: '응용영역', offeringDepartmentName: '정보통신전자공학부' },
    { trackId: 14, courseCode: '06196', courseName: '데이터과학을위한프로그래밍', area: '응용영역', offeringDepartmentName: '경영학과' },
    { trackId: 14, courseCode: '04578', courseName: '객체지향프로그래밍설계', area: '응용영역', offeringDepartmentName: '인공지능학과' },
    { trackId: 14, courseCode: '06913', courseName: 'ICTHW/SW융합서비스캡스톤디자인', area: '응용영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04480', courseName: '디지털스토리텔링입문', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04478', courseName: '영상창작기초', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '05294', courseName: '미디어콘텐츠디자인1', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04867', courseName: '발상표현과스토리보드', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04483', courseName: '3D애니메이션1', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04486', courseName: '3D애니메이션2', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04683', courseName: '영상편집과특수효과1', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04693', courseName: '영상편집과특수효과2', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04692', courseName: '영상제작세미나', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '05531', courseName: '미디어콘텐츠캡스톤디자인1', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '05532', courseName: '미디어콘텐츠캡스톤디자인2', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '03994', courseName: '인터랙션디자인', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '06083', courseName: '디지털스토리텔링캡스톤디자인', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '05800', courseName: '창의적콘텐츠프로젝트종합설계', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04487', courseName: '인터렉티브프로젝트실습', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04865', courseName: '디지털영상제작', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04685', courseName: '콘텐츠분석', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '05291', courseName: '미디어콘텐츠디자인2', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04479', courseName: '영상콘텐츠창작실습', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '05694', courseName: '지적재산권의이해와실무', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '05424', courseName: '스마트미디어기획실습', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04866', courseName: '콘텐츠산업의이해', area: '기획창작영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '05513', courseName: '디지털미디어공학개론', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04481', courseName: '창의입문설계', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '06001', courseName: '데이터구조개론및응용', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04010', courseName: '선형대수학', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '05793', courseName: '디지털미디어정보수학', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04695', courseName: '윈도우즈프로그래밍', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '06000', courseName: '미디어정보처리회로및응용', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '06265', courseName: '객체지향프로그래밍', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04015', courseName: '확률과통계', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '06266', courseName: '기계학습입문', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '06264', courseName: '컴퓨터비전입문', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04587', courseName: '게임프로그래밍', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '06684', courseName: '영상처리알고리즘입문', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '06267', courseName: '인공지능비즈니스모델의이해', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '03993', courseName: '컴퓨터그래픽스', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '03980', courseName: '컴퓨터애니메이션', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '04497', courseName: '비주얼특수효과', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '05801', courseName: '창의적미디어프로젝트종합설계', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '05574', courseName: '스마트미디어캡스톤디자인', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '05835', courseName: '스마트미디어웨어러블IoT융합종합설계', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '05078', courseName: '가상및증강현실', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '06685', courseName: '컴퓨터그래픽스와딥러닝', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '06268', courseName: '기계학습응용', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '06914', courseName: '컴퓨터비전응용', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '06915', courseName: '휴먼컴퓨터인터랙션디자인', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
    { trackId: 15, courseCode: '06913', courseName: 'ICTHW/SW융합서비스캡스톤디자인', area: '콘텐츠비즈니스영역', offeringDepartmentName: null },
  ];
  await prisma.trackCourseRecognition.deleteMany({ where: { departmentId: MTC_DEPT_ID } });
  for (const r of TRACK_COURSE_RECOGNITIONS) {
    await prisma.trackCourseRecognition.create({
      data: {
        departmentId: MTC_DEPT_ID,
        trackId: r.trackId,
        courseCode: r.courseCode,
        courseName: r.courseName,
        area: r.area,
        offeringDepartmentName: r.offeringDepartmentName,
      },
    });
  }
  ...
  const GRADUATION_REQUIREMENTS: GraduationRequirementSeed[] = [
    ...
    },
    {
      ...
      sourceUrl: 'https://mtc.catholic.ac.kr/mtc/course/academic.do',
      notes:
        '[2026-07] 세부 인정과목은 ★미디어기술콘텐츠학과 트랙교과목_20240813.pdf 원문에서 확인, TRACK_COURSE_RECOGNITIONS로 직접 시드 — 기획창작영역/콘텐츠비즈니스영역 각 최소 3학점.',
    },
    {
      id: 4,
      departmentId: 345,
      ...
      sourceUrl: 'https://mtc.catholic.ac.kr/mtc/course/academic.do',
      notes:
        '[2026-07] 세부 인정과목은 ★미디어기술콘텐츠학과 트랙교과목_20240813.pdf 원문에서 확인, TRACK_COURSE_RECOGNITIONS로 직접 시드 — 기초영역/필수영역/응용영역 각 최소 3학점.',
    },
    {
      id: 5,
      departmentId: 345,
      ...
      sourceUrl: 'https://mtc.catholic.ac.kr/mtc/course/academic.do',
      notes:
        '테크니컬아티스트트랙 전용 졸업작품 옵션이 원문에 별도로 명시되지 않음 — 학과사무실 확인 권장. [2026-07] 세부 인정과목은 ★미디어기술콘텐츠학과 트랙교과목_20240813.pdf 원문에서 확인, TRACK_COURSE_RECOGNITIONS로 직접 시드 — 기획창작영역/콘텐츠비즈니스영역 각 최소 6학점(문화콘텐츠트랙의 2배).',
    },
